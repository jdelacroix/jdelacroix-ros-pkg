...
#ifndef ROS_KHEPERA3_CONTROLLER_WINGLION_H_
#define ROS_KHEPERA3_CONTROLLER_WINGLION_H_
...
class WingLion {
 ...
 private:
  ...
  double lion_separation_;
  std::string lion_position_;
...
#endif /* ROS_KHEPERA3_CONTROLLER_WINGLION_H_ */
